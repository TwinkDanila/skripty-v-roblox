Здесь будет рассказывается о том как использовать что-либо, будто скрипты, объекты, функции и тд., и иногда будут посты о достаточно интересных обновлениях 
